...
El repo incluye un workflow de GitHub Actions que replica cada push de GitHub hacia GitLab. Para activarlo, crear en GitHub un secret de Actions llamado `GITLAB_TOKEN` con un Personal Access Token de GitLab que tenga permiso `write_repository` sobre `lu-developer476/Dofus-Duelists`.
